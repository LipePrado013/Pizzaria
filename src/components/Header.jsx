...
function Header () {
    ...
    return(
        <>
            <div className="w-full fixed bg-white h-32 flex items-end justify-around gap-5 p-5 text-black max-[966px]:justify-around max-[966px]:items-center max-[500px]:justify-between shadow-[0_-10px_25px_2px_black]"> 
                <div className=''>
                ...
                <button onClick={onClick} className='max-[966px]:block text-4xl hidden'><i class="fa-solid fa-bars"></i></button>
